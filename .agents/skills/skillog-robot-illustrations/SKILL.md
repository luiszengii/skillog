...
For workspace-bound output, save selected files under `assets/<content-slug>-illustrations/` with ordered descriptive names. Preserve existing assets and the original generated file unless the user explicitly requests replacement.
